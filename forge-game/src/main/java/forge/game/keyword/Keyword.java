...
public enum Keyword {
    ...
    EVOLVE_FROM("Evolve from", EvolveFrom.class, false, "If you cast this spell for its evolve cost, put it over target creature you own named %s. They evolve into CARDNAME %splus %s's abilities."),
